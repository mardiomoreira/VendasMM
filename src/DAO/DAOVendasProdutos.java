...
public class DAOVendasProdutos extends ConexaoMySql {
    ...
    public boolean atualizarVendasProdutosDAO(ModelVendasProdutos pModelVendasProdutos) {
        try {
            ...
            return this.executarUpdateDeleteSQL(
                    ...
                    + "venpro_quantidade = '" + pModelVendasProdutos.getVenproQuantidade() + "'"
                    + " WHERE "
                    + "pk_id_venda_produto = '" + pModelVendasProdutos.getIdVendaProduto() + "'"
                    + ";"
            );
    ...
    public boolean salvarVendasProdutosDAO(ArrayList<ModelVendasProdutos> listaModelVendasProdutoses) {
            try {
            this.conectar();
            int cont = listaModelVendasProdutoses.size();
            for (int i = 0; i < cont; i++) {
                this.insertSQL(
                        ...
                        + "venpro_quantidade"
                        + ") VALUES ("
                        + "'" + listaModelVendasProdutoses.get(i).getVendas() + "',"
